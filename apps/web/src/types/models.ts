// Original File: https://github.com/DesModder/DesModder/blob/main/src/globals/models.ts
/**
...
export interface ValueTypeMap {
  ...
  [ValueType.Segment]: [start: ValueTypeMap[ValueType["Point"]], end: ValueTypeMap[ValueType["Point"]]];
  ...
  [ValueType.Line]: [p0: ValueTypeMap[ValueType["Point"]], p1: ValueTypeMap[ValueType["Point"]]];
  [ValueType.ListOfLine]: ValueTypeMap[ValueType["Line"]][];
  [ValueType.Ray]: [origin: ValueTypeMap[ValueType["Point"]], direction: ValueTypeMap[ValueType["Point"]]];
  [ValueType.ListOfRay]: ValueTypeMap[ValueType["Ray"]][];
  [ValueType.Vector]: [vector: ValueTypeMap[ValueType["Point"]], start: ValueTypeMap[ValueType["Point"]]];
  ...
  [ValueType.Segment3D]: [start: ValueTypeMap[ValueType["Point3D"]], end: ValueTypeMap[ValueType["Point3D"]]];
  ...
  [ValueType.Sphere3D]: [center: ValueTypeMap[ValueType["Point3D"]], radius: number];
  [ValueType.ListOfSphere3D]: ValueTypeMap[ValueType["Sphere3D"]][];
  [ValueType.Vector3D]: [vector: ValueTypeMap[ValueType["Point3D"]], start: ValueTypeMap[ValueType["Point3D"]]];
  ...
  [ValueType.ConfidenceInterval]: [min: number, max: number, standardError: number, dof: number];
  [ValueType.ListOfConfidenceInterval]: ValueTypeMap[ValueType["ConfidenceInterval"]][];
  [ValueType.OneSampleTInference]: [count: number, mean: number, stdev: number, dof: number];
  ...
  [ValueType.RegressionTInference]: [pointEstimate: number, standardError: number, dof: number];
  [ValueType.ListOfRegressionTInference]: ValueTypeMap[ValueType["RegressionTInference"]][];
  [ValueType.OneSampleZInference]: [count: number, mean: number, stdevp: number];
  ...
  [ValueType.TwoProportionZInference]: [successes1: number, count1: number, successes2: number, count2: number];
  ...
  [ValueType.ZSignificanceTest]: [p: number, score: number, hypothesis: number, pleft: number, pright: number];
...
export type TypedConstantValue<T extends ConstantValueType = ConstantValueType> = T extends T
  ? {
      valueType: T;
...
type OrListType<T extends ListElementValueType> = T | ReverseMap<ListElementTypeMap>[T];
...
export interface ExpressionModel extends BasicSetExpression, NonfolderItemModelBase {
  type?: "expression";
  fill?: boolean;
  secret?: boolean;
  sliderBounds?: {
