// Original File: https://github.com/DesModder/DesModder/blob/main/src/components/desmosComponents.ts
import { ClassComponent, DCGView } from "./DCGView";
import { Calc, Desmos } from "./globals/window";
const { Fragile } = Desmos.Private;
...
export const { If, For, IfDefined, IfElse, Input, Switch, SwitchUnion, Textarea } = DCGView.Components;
