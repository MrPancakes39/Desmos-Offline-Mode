// Original File: https://github.com/DesModder/DesModder/blob/main/src/components/SegmentedControl.tsx
...
export default class SegmentedControl extends Component<{
  ...
  getStaticConfig() {
    return this.props.names().map((name, i) => ({
      ...
      onSelect: () => this.getChangeAllowed(i) && this.props.setSelectedIndex(i),
    }));
  }

  getChangeAllowed(i: number) {
    const allowChange = this.props.allowChange;
    return allowChange === undefined || allowChange() === true || i === this.props.selectedIndex();
  }
}
