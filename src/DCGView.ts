...
import { Desmos } from "./globals/window";
...
export interface DCGViewModule {
  ...
  const: <T>(v: T) => () => T;
  createElement: (el: ComponentArgument, props: Props, ...children: ComponentArgument[]) => unknown;
...
export function JSX(el: ComponentArgument, props: LooseProps, ...children: ComponentArgument[]) {
